      ...
      Object.entries(activities).forEach(([name, details]) => {
        ...
        const participantsHtml = details.participants.length
          ? details.participants.map((participant) => `
            <li class="participant-item" data-email="${participant}">
              <span class="participant-email">${participant}</span>
              <button class="participant-delete" data-activity="${encodeURIComponent(name)}" data-email="${participant}" title="Unregister">✖</button>
            </li>
          `).join("")
        ...
        // Attach delete handlers for this activity
          ...
          btn.addEventListener("click", async (e) => {
            ...
            try {
              ...
              if (res.ok) {
                ...
                messageDiv.textContent = json.detail || "Failed to unregister participant";
